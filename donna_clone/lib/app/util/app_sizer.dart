...
final class AppSizer {
  ...
  static EdgeInsets get pageHorizontalPadding => EdgeInsets.symmetric(horizontal: scaleWidth(16));
  static EdgeInsets horizontalPadding(double v) => EdgeInsets.symmetric(horizontal: scaleWidth(v));
  static EdgeInsets verticallPadding(double v) => EdgeInsets.symmetric(vertical: scaleHeight(v));
